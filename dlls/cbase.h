...
// Shepard : SoHL's evil state system

typedef enum
{
	STATE_OFF = 0,	// Disabled, inactive, invisible, closed, stateless or non-alert monster.
	STATE_TURN_ON,	// Door opening, env_fade fading in...
	STATE_ON,		// Enabled, active, visible, opened, or alert monster.
	STATE_TURN_OFF,	// Door closing, env_fade fading out...
	STATE_IN_USE	// Player is in control (train/track/Barney/Scientist).
} STATE;
...
//	virtual void	SetActivator( CBaseEntity *pActivator ) {}
	...
	int m_iParaExtraStuff;
	int m_iParaExtraStuff2;

	// Shepard : All of this because of a Spirit entity that requires it's state system >_<
...
#define DMG_CLUB			(1 << 7)	// punch, headbutt
...
#define DMG_GIB_CORPSE		( DMG_CRUSH | DMG_FALL | DMG_BLAST | DMG_SONIC | DMG_CLUB | DMG_SLASH )
...
// Shepard : Moved from "triggers.cpp" to allow CBaseTrigger
// entities to be created in other files than "triggers.cpp"

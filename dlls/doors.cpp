...
void CBaseDoor::Blocked( CBaseEntity *pOther )
{
	...
	// Shepard - This should do the trick
	if ( (pOther->pev->flags & FL_MONSTER) && !(pOther->pev->flags & FL_CLIENT) && (pOther->pev->deadflag != DEAD_NO) )
		pOther->TakeDamage( pev, pev, 999.0f, DMG_CRUSH );

...
extern CBaseEntity	*UTIL_FindEntityByTargetname(CBaseEntity *pStartEntity, const char *szName, CBaseEntity *pActivator ); // LRC
...
extern void			UTIL_ShowMessagePVS		( const char *pString, const Vector &vecOrg ); // Shepard : PARANOIA subtitles system
...
#define SF_BREAK_SABER			256// instant break if hit with the saber

...
int CHudBattery::Draw(float flTime)
{
	...
	y = ScreenHeight - gHUD.m_iFontHeight - gHUD.m_iFontHeight / 2 - 8.0f; // Shepard : Added -8 for offset correction.
	x = ScreenWidth/5;
	...
	x += (m_prc1->right - m_prc1->left) - 16.0f; // Shepard : Added -16 for offset correction.
	x = gHUD.DrawHudNumber(x, y + 8.0f, DHN_3DIGITS | DHN_DRAWZERO, m_iBat, r, g, b); // Shepard : Added +8 for offset correction.

...
DECLARE_MESSAGE( m_ItemCocaine, ItemCocaine );

int CHudItemCocaine::Init( void )
{
	HOOK_MESSAGE( ItemCocaine );
...
int CHudItemCocaine::VidInit( void )
{
	m_hIcon = gHUD.GetSpriteIndex( "cocaine" );
	return 1;
}

int CHudItemCocaine::MsgFunc_ItemCocaine( const char *pszName, int iSize, void *pbuf )
{
...
int CHudItemCocaine::Draw( float flTime )
{

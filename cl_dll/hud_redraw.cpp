...
{
	// Shepard : Initialize or update the music engine
	...
	{  // only let players adjust up in fov,  and only if they are not overriden by something else
		// Shepard : fix compile error on Linux
	...
	// Shepard : scroll the credits
	if ( gViewPort && gViewPort->m_pHRPCredits && gViewPort->m_pHRPCredits->isVisible() )
		gViewPort->m_pHRPCredits->Scroll();

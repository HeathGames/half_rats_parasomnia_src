...
DECLARE_MESSAGE( m_ItemWhiskey, ItemWhiskey );

int CHudItemWhiskey::Init( void )
{
	HOOK_MESSAGE( ItemWhiskey );
...
int CHudItemWhiskey::VidInit( void )
{
	m_hIcon = gHUD.GetSpriteIndex( "whiskey" );
	return 1;
}

int CHudItemWhiskey::MsgFunc_ItemWhiskey( const char *pszName, int iSize, void *pbuf )
{
...
int CHudItemWhiskey::Draw( float flTime )
{

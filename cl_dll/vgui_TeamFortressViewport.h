...
#define MENU_HRP_BUY				10 // Shepard : HR:P VGUI buy menu
#define MENU_HRP_CREDITS			11 // Shepard : HR:P VGUI credits
#define MENU_HRP_NEWGAME			12 // Shepard : HR:P VGUI new game menu
#endif
...
class CHRPBuyMenuPanel; // Shepard : HR:P VGUI buy menu
class CHRPCreditsPanel; // Shepard : HR:P VGUI credits
class CHRPNewGameMenuPanel; // Shepard : HR:P VGUI new game menu
class CVGUIDebugOverlay; // Shepard : Debugging overlay
...
private:
	...
	void		 CreateHRPBuyMenu( void ); // Shepard : HR:P VGUI buy menu
	CMenuPanel*	 ShowHRPBuyMenu( void ); // Shepard : HR:P VGUI buy menu
	void		 CreateHRPCredits( void ); // Shepard : HR:P VGUI credits
	CMenuPanel*	 ShowHRPCredits( void ); // Shepard : HR:P VGUI credits
	void		 CreateHRPNewGameMenu( void ); // Shepard : HR:P VGUI new game menu
	CMenuPanel*	 ShowHRPNewGameMenu( void ); // Shepard : HR:P VGUI new game menu
	void		 CreateSubtitlesMenu( void ); // Shepard : PARANOIA subtitles system
	void		 CreateDebugOverlay( void ); // Shepard : Debugging overlay
...
public:
	...
	CHRPBuyMenuPanel *m_pHRPBuyMenu; // Shepard : HR:P VGUI buy menu
	CHRPCreditsPanel *m_pHRPCredits; // Shepard : HR:P VGUI credits
	CHRPNewGameMenuPanel *m_pHRPNewGameMenu; // Shepard : HR:P VGUI new game menu
	CSubtitles *m_pSubtitles; // Shepard : PARANOIA subtitles system
	CVGUIDebugOverlay *m_pDebugOverlay; // Shepard : Debugging overlay
...
#include "hrp_vgui_buy_menu.h" // Shepard : HR:P VGUI buy menu
#include "hrp_vgui_credits.h" // Shepard : HR:P VGUI credits
#include "hrp_vgui_new_game.h" // Shepard : HR:P VGUI new game menu

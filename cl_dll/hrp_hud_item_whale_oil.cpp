...
DECLARE_MESSAGE( m_ItemWhaleOil, ItemOil );

int CHudItemWhaleOil::Init( void )
{
	HOOK_MESSAGE( ItemOil );
...
int CHudItemWhaleOil::VidInit( void )
{
	m_hIcon = gHUD.GetSpriteIndex( "whale_oil" );
	return 1;
}

int CHudItemWhaleOil::MsgFunc_ItemOil( const char *pszName, int iSize, void *pbuf )
{
...
int CHudItemWhaleOil::Draw( float flTime )
{

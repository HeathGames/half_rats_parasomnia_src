...
// Shepard : Should name this "RGB_WHITEISH" but 1) I'm lazy and 2) I don't want to mess my merge tool (yet) ^^
...
public:
	...
	WEAPON *m_pWeapon; // Shepard : Made this public because I need it for the shotgun shells indicator
private:
	float m_fFade;
	RGBA  m_rgba;
	int	m_HUD_bucket0;
...
private:
	...
	// HR:P lantern
	HLSPRITE m_hLanternOff;
	HLSPRITE m_hLanternOn;
};
...
// HR:P items
#include "hrp_hud_buy_zone.h"
#include "hrp_hud_item_cocaine.h"
#include "hrp_hud_item_drymeat.h"
#include "hrp_hud_item_meatpie.h"
#include "hrp_hud_item_whiskey.h"
#include "hrp_hud_item_whale_oil.h"
#include "hrp_hud_item_selected.h"
#include "hrp_hud_money.h"
#include "hrp_hud_weapon_shotgun.h"
...
public:
	...
	CHudItemCocaine		m_ItemCocaine;
	CHudItemDrymeat		m_ItemDrymeat;
	CHudItemMeatpie		m_ItemMeatpie;
	CHudItemWhiskey		m_ItemWhiskey;
	CHudItemWhaleOil	m_ItemWhaleOil;
	CHudItemSelected	m_ItemSelect;
	CHudMoney			m_Money;
	CHudWeaponShotgun	m_WeaponShotgun;
	...
	int m_iDesiredBody; // Shepard : Client-side MDL body
	int m_iHenryIronsight;
};

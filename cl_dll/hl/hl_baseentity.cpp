...
CBaseEntity* CBaseMonster :: CheckTraceHullAttack( float flDist, int iDamage, int iDmgType, BOOL bCheckFriendlyFire ) { return NULL; }
...
float CBasePlayer::GetDamageBoost( void ) { return 0.0f; } // Shepard : Fixes a compile error with the saber

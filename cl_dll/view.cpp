...
#endif
		{ "models/p_saber.mdl",			"models/v_saber.mdl"		},
		{ "models/p_colt.mdl",			"models/v_colt.mdl"			},
		{ "models/p_henry.mdl",			"models/v_henry.mdl"		},
		{ "models/p_shotgun.mdl",		"models/v_shotgun.mdl"		},
#ifdef USE_MP_WEAPONS
		{ "models/p_bow.mdl",			"models/v_bow.mdl"			},
#endif
		{ "models/p_gatling.mdl",		"models/v_gatling.mdl"		},
		{ "models/p_dynamite.mdl",		"models/v_dynamite.mdl"		},
#ifdef USE_MP_WEAPONS
		{ "models/p_halfcat.mdl",		"models/v_halfcat.mdl"		},
#endif
		{ NULL, NULL } };

...
DECLARE_MESSAGE( m_ItemDrymeat, ItemDrymeat );

int CHudItemDrymeat::Init( void )
{
	HOOK_MESSAGE( ItemDrymeat );
...
int CHudItemDrymeat::VidInit( void )
{
	m_hIcon = gHUD.GetSpriteIndex( "drymeat" );
	return 1;
}

int CHudItemDrymeat::MsgFunc_ItemDrymeat( const char *pszName, int iSize, void *pbuf )
{
...
int CHudItemDrymeat::Draw( float flTime )
{
